...
var CONST = _interopRequireWildcard(require("./constants/string.datatypes.constants"));
 ...
 */
describe("Test input data type Property", function () {
  /**
   * 
  ...
  */
  var setup = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(config) {
      var data, handleSubmit, _render, container, nameInput, submitButton;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            })), container = _render.container; //logRoles(container)
            // enter a name 
            nameInput = document.getElementById("root_name"); // check if name input is available
            expect(nameInput).toBeInTheDocument();
            // clear 
            _context.next = 7;
            return _userEvent["default"].clear(nameInput);
          case 7:
            _context.next = 9;
            return _userEvent["default"].type(nameInput, config.input);
          case 9:
  ...
  test("Create string type property", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var config, data;
  ...
  test("Edit string type property", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
    var config, data;
  ...
  test("View string type property", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
    var _render2, container, nameInput;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          ...
          nameInput = document.getElementById("root_name"); // expect the name input to be in document
          expect(nameInput).toBeInTheDocument();
          // expect correct filled data to be displayed in text area 
          expect(nameInput.value).toStrictEqual(CONST.VIEW_CONFIG.formData.name);
        case 5:
        case "end":
