...
var CONST = _interopRequireWildcard(require("./constants/circularDocumentLinks.datatypes.constants"));
 ...
 */
describe("Test Circular Document Links - CREATE MODE", function () {
  /**
   * 
  ...
  */
  var setup = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(config) {
      var data, handleSubmit, _render, container, nameInput, createNew, likes_category_1, likes_nickName_1, createNew_2, owned_by_name_2, createNew_3, likes_category_3, categoryInput_3, likes_nickName_3, nickNameInput_3, createNew_4, owned_by_name_4, ownedByNameInput_4, submitButton;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          ...
          case 12:
            ...
            likes_nickName_1 = document.getElementById("root_likes_nickName_1"); // check if likes_nickName_1 root input is available
            expect(likes_nickName_1).toBeInTheDocument();
            // enter a likes_nickName_1 root value
            _react.fireEvent.change(likes_nickName_1, {
              target: {
                value: config.input["likes"]["nickName"]
              }
            });
          ...
          case 32:
            ...
            likes_nickName_3 = document.getElementById("root_likes_nickName_3"); // check if likes_nickName_3 root input is available
            expect(likes_nickName_3).toBeInTheDocument();
            nickNameInput_3 = config.input["likes"]["owned_by"]["likes"]["nickName"]; // enter a likes_category_3 root value
            _react.fireEvent.change(likes_nickName_3, {
              target: {
                value: nickNameInput_3
              }
            });

            // FILLING DEPTH 4 ( owned_by User )
            createNew_4 = document.getElementById("Create New Document__4");
            _context.next = 43;
          ...
          case 45:
            owned_by_name_4 = document.getElementById("root_owned_by_name_4"); // check if owned_by_name_4 root input is available
            _context.next = 48;
            return expect(owned_by_name_4).toBeInTheDocument();
          case 48:
            ownedByNameInput_4 = config.input["likes"]["owned_by"]["likes"]["owned_by"]["name"]; // enter a owned_by_name_4 root value
            _react.fireEvent.change(owned_by_name_4, {
              target: {
                value: ownedByNameInput_4
              }
            });
  ...
  test("Create Circular Document Link property", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var config, data;
