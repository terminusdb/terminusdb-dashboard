  ...
  */
  var setup = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(config) {
      var data, handleSubmit, _render, container, owned_by_name_2, unLink_Button_3, linkNew, divInput, submitButton;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          ...
          case 7:
            ...
            unLink_Button_3 = document.getElementById("3");
            expect(unLink_Button_3).toBeInTheDocument();
            _context.next = 12;
            return _userEvent["default"].click(unLink_Button_3);
          case 12:
            // FILLING DEPTH 3 ( likes Animal )
            // link an ID at this point
            linkNew = document.getElementById("Link an existing Document__3");
            _context.next = 15;
            return expect(linkNew).toBeInTheDocument();
          case 15:
            _context.next = 17;
            return _userEvent["default"].click(linkNew);
          case 17:
            // expect search component to appear 
            // add an ID from Search component  
            divInput = document.getElementById(config.input["likes"]["owned_by"]["likes"]); // check if divInput input is available
  ...
  test("Edit Existing Document Link  property", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var config, data;
