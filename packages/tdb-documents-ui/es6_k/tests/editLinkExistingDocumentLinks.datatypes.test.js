...
var CONST = _interopRequireWildcard(require("./constants/existingDocumentLinks.datatypes.constants"));
  ...
  */
  var setup = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(config) {
      var data, handleSubmit, _render, container, selectedInput, changeLinkButton, divInput, submitButton;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            selectedInput = document.getElementById(config.formData["likes"]);
            expect(selectedInput).toBeInTheDocument();

            // click on change link 
            changeLinkButton = _react.screen.getByRole("button", {
              name: "Change Link"
            });
            expect(changeLinkButton).toBeInTheDocument;
            _context.next = 10;
            return _userEvent["default"].click(changeLinkButton);
          case 10:
            // expect search component to appear 
            // add an ID from Search component  
            divInput = document.getElementById(config.input["likes"]); // check if divInput input is available
