...
var CONST = _interopRequireWildcard(require("./constants/choiceSubDocuments.datatypes.constants"));
...
function expectElemenstToBeFilled(_x) {
  return _expectElemenstToBeFilled.apply(this, arguments);
}
/**
 ...
 */
function _expectElemenstToBeFilled() {
  _expectElemenstToBeFilled = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(config) {
    var botonyNotesInput, botonyGradeInput, subjectNameInput;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          // expect Botony_notes to be filled 
          botonyNotesInput = document.getElementById("root_favorite_subject_Botony_notes"); //const botonyNotesInput=screen.getByRole("textbox", { name: "Botony_notes" })
          _context4.next = 3;
          return expect(botonyNotesInput).toBeInTheDocument();
        case 3:
          ...
          botonyGradeInput = document.getElementById("root_favorite_subject_Botony_grade");
          ...
          subjectNameInput = document.getElementById("root_favorite_subject_subject_name");
...
describe("Test Edit Choice Subdocuments", function () {
  /**
   * 
  ...
  */
  var setup = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(config) {
      var data, handleSubmit, _render, container, getByLabelText, zoologySubjectNameInput, zoologyNotesInput, subjectNameInput, submitButton;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            // swap to Zoology 
            _context.next = 7;
            return _reactSelectEvent["default"].select(getByLabelText('favorite_subject'), [config.input["favorite_subject"]["@type"]]);
          case 7:
            // expect subject_name to be empty 
            zoologySubjectNameInput = document.getElementById("root_favorite_subject_subject_name");
            expect(zoologySubjectNameInput).toBeInTheDocument();
            expect(zoologySubjectNameInput).toBeEmptyDOMElement();

            // swap back to Botony
            _context.next = 12;
            return _reactSelectEvent["default"].select(getByLabelText('favorite_subject'), [config.formData["favorite_subject"]["@type"]]);
          case 12:
            // checks if fields are filled for Botony
            expectElemenstToBeFilled(config);
          ...
          case 15:
            ...
            zoologyNotesInput = document.getElementById("root_favorite_subject_Zoology_notes");
            expect(zoologyNotesInput).toBeInTheDocument();
            _react.fireEvent.change(zoologyNotesInput, {
              target: {
                value: config.input["favorite_subject"]["Zoology_notes"]
              }
            });
            ...
            subjectNameInput = document.getElementById("root_favorite_subject_subject_name");
            expect(subjectNameInput).toBeInTheDocument();
            _react.fireEvent.change(subjectNameInput, {
              target: {
                value: config.input["favorite_subject"]["subject_name"]
              }
            });
  ...
  test("Edit Choice SubDocument property", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var config, data;
  ...
  test("View Choice SubDocument property", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
    var config, _render2, container;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          config = CONST.VIEW_CONFIG; // render FrameViewer 
