 ...
 */
describe("Test Self linked Document Links - CREATE MODE", function () {
  /**
   * 
  ...
  */
  var setup = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(config) {
      var data, handleSubmit, _render, container, nameInput, ageInput, createNew, nameInput_1, ageInput_1, createNew_2, nameInput_2, ageInput_2, submitButton;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            ageInput = _react.screen.getByRole("spinbutton", {
              name: "age"
            }); // check if ageInput root input is available
            expect(ageInput).toBeInTheDocument();
            // enter a ageInput root value
            _react.fireEvent.change(ageInput, {
              target: {
                value: config.input["age"]
              }
            });
          ...
          case 15:
            ...
            _react.fireEvent.change(nameInput_1, {
              target: {
                value: config.input["friends_with"]["name"]
              }
            });
  ...
  test("Create  Self linked Document Link property", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var config, data;
