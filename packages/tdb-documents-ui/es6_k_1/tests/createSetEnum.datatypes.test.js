...
var CONST = _interopRequireWildcard(require("./constants/setEnum.datatypes.constants"));
 ...
 */
describe("Test Create Set Enum data type Property", function () {
  /**
   * 
  ...
  */
  var setup = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(config) {
      var data, handleSubmit, _render, container, getByLabelText, addLikesColorButton, submitButton;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            // add enum 
            addLikesColorButton = _react.screen.getByRole("button", {
              name: "Add likes_color"
            });
            expect(addLikesColorButton).toBeInTheDocument();
            _context.next = 8;
            return _userEvent["default"].click(addLikesColorButton);
          case 8:
            _context.next = 10;
            return _reactSelectEvent["default"].select(getByLabelText('likes_color'), [config.input[0]]);
          case 10:
  ...
  test("Create enum type property Set", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var config, data;
