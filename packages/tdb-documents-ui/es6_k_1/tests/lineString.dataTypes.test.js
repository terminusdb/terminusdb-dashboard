 ...
 */
describe("Test line string data type Property", function () {
  /**
   * 
  ...
  */
  var setup = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(config) {
      var data, handleSubmit, _render, container, getByLabelText, leftInput, bottomInput, rightInput, topInput, buttonInput, latitudeInput, longiudeInput, latitudeInput_1, longiudeInput_1, latitudeInput_2, longiudeInput_2, submitButton;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 16;
            return expect(topInput).toBeInTheDocument();
          case 16:
            ...
            // Add coordinates 
            buttonInput = _react.screen.getByRole("button", {
              name: "Add Coordinates"
            });
            _context.next = 20;
            return expect(buttonInput).toBeInTheDocument();
          case 20:
            _context.next = 22;
            return _userEvent["default"].click(buttonInput);
          case 22:
            // LINE STRING  coordinates
            // FIRST ENTRY
            // enter latitude
            latitudeInput = document.getElementById("latitude__0");
            expect(latitudeInput).toBeInTheDocument();
            _react.fireEvent.change(latitudeInput, {
              target: {
                value: config.input["coordinates"][0][0]
              }
            });
            ...
            _react.fireEvent.change(longiudeInput, {
              target: {
                value: config.input["coordinates"][0][1]
              }
            });
          ...
          case 30:
            // enter latitude
            latitudeInput_1 = document.getElementById("latitude__1");
            _context.next = 33;
            return expect(latitudeInput_1).toBeInTheDocument();
          case 33:
            _react.fireEvent.change(latitudeInput_1, {
              target: {
                value: config.input["coordinates"][1][0]
              }
            });
            ...
            _react.fireEvent.change(longiudeInput_1, {
              target: {
                value: config.input["coordinates"][1][1]
              }
            });
          ...
          case 39:
            // enter latitude
            latitudeInput_2 = document.getElementById("latitude__2");
            _context.next = 42;
            return expect(latitudeInput_2).toBeInTheDocument();
          case 42:
            _react.fireEvent.change(latitudeInput_2, {
              target: {
                value: config.input["coordinates"][2][0]
              }
            });
            ...
            _react.fireEvent.change(longiudeInput_2, {
              target: {
                value: config.input["coordinates"][2][1]
              }
            });
          ...
          case 48:
            ...
            _context.next = 51;
            return expect(submitButton).toBeInTheDocument();
          case 51:
            _context.next = 53;
  ...
  test("Create line string type property", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var config, data;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          config = CONST.LINE_STRING_CREATE_CONFIG; // setup FrameViewer 
          _context2.next = 3;
          return setup(config);
        case 3:
          data = _context2.sent;
