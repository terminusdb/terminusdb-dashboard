...
var CONST = _interopRequireWildcard(require("./constants/subDocumentSets.datatypes.constants.js"));
...
function addFields(index, input) {
  ...
  var addressLineInput = document.getElementById("root_previous_addresses_".concat(index, "__").concat(index, "_AddressLine1"));
  expect(addressLineInput).toBeInTheDocument();
  _react.fireEvent.change(addressLineInput, {
    target: {
  ...
  // enter a City
  var cityInput = document.getElementById("root_previous_addresses_".concat(index, "__").concat(index, "_City"));
  ...
  // enter a Country
  var countryInput = document.getElementById("root_previous_addresses_".concat(index, "__").concat(index, "_Country"));
  ...
  // enter postal code
  var postalCodeInput = document.getElementById("root_previous_addresses_".concat(index, "__").concat(index, "_postalCode"));
 ...
 * subdoucment Address
 */
describe("Test Subdocuments - SETs", function () {
  /**
   * 
  ...
  */
  var setup = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(config) {
      var data, handleSubmit, _render, container, deleteSecond, addPreviousAddress, submitButton;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            // delete second entry
            deleteSecond = document.getElementById("Remove_root_previous_addresses_1__1");
            _context.next = 9;
            return expect(deleteSecond).toBeInTheDocument();
          case 9:
            _context.next = 11;
            return _userEvent["default"].click(deleteSecond);
          case 11:
            // add another entry 
            addPreviousAddress = _react.screen.getByRole("button", {
              name: "Add previous_addresses"
            });
            expect(addPreviousAddress).toBeInTheDocument();
            // click on subdocument button to add set
            _context.next = 15;
            return _userEvent["default"].click(addPreviousAddress);
          case 15:
  ...
  test("Edit SubDocument property - SETs", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var config, data;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 3:
          data = _context2.sent;
          _context2.next = 6;
          return expect(data).toStrictEqual(CONST.SET_SUBDOCUMENT_DATA_TYPE_EDIT_DATA);
        case 6:
        case "end":
