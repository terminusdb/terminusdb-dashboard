 ...
 */
describe("Test Circular Document Links - View MODE", function () {
  // View a document link type property
  test("View Circular Document Link property", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var config, _render, container, nameInput, likes_nickName_1, likes_category_1, nameInput_2, likes_nickName_3, likes_category_3, nameInput_4;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 6:
          ...
          likes_nickName_1 = document.getElementById("root_likes_nickName_1");
          _context.next = 10;
          return expect(likes_nickName_1).toBeInTheDocument();
        case 10:
          expect(likes_nickName_1.value).toStrictEqual(config.formData["likes"]["nickName"]);

          // checking DEPTH 1 ( likes )
          likes_category_1 = document.getElementById("root_likes_category_1");
          _context.next = 14;
          return expect(likes_category_1).toBeInTheDocument();
        case 14:
          expect(likes_category_1.value).toStrictEqual(config.formData["likes"]["category"]);

          // checking DEPTH 2 ( owned_by User )
          nameInput_2 = document.getElementById("root_owned_by_name_2");
          _context.next = 18;
        ...
        case 18:
          ...
          likes_nickName_3 = document.getElementById("root_likes_nickName_3");
          _context.next = 22;
          return expect(likes_nickName_3).toBeInTheDocument();
        case 22:
          expect(likes_nickName_3.value).toStrictEqual(config.formData["likes"]["owned_by"]["likes"]["nickName"]);

          // checking DEPTH 3 ( likes )
          likes_category_3 = document.getElementById("root_likes_category_3");
          _context.next = 26;
          return expect(likes_category_3).toBeInTheDocument();
        case 26:
          expect(likes_category_3.value).toStrictEqual(config.formData["likes"]["owned_by"]["likes"]["category"]);

          // checking DEPTH 4 ( owned_by User )
          nameInput_4 = document.getElementById("root_owned_by_name_4");
          _context.next = 30;
          return expect(nameInput_4).toBeInTheDocument();
        case 30:
