...
var CONST = _interopRequireWildcard(require("./constants/nestedSubDocuments.datatypes.constants"));
  ...
  */
  var setup = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(config) {
      var data, handleSubmit, _render, container, zipInput, eirInput, nameInput, submitButton;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            // zip
            zipInput = _react.screen.getByRole('textbox', {
              name: "zip"
            }); // check if zip
            expect(zipInput).toBeInTheDocument();
            // enter a zip
            _react.fireEvent.change(zipInput, {
              target: {
                value: config.input["lives"]["postalCode"]["zip"]
              }
            });

            // eir
            eirInput = _react.screen.getByRole('textbox', {
              name: "eir"
            }); // check if eir
            expect(eirInput).toBeInTheDocument();
            // enter a eir
            _react.fireEvent.change(eirInput, {
              target: {
                value: config.input["lives"]["postalCode"]["eir"]
              }
            });
            ...
            _react.fireEvent.change(nameInput, {
              target: {
                value: config.input["lives"]["postalCode"]["shared_by"]["name"]
              }
            });
  ...
  test("View SubDocument type property", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
    var _render2, container, zipInput, eirInput, nameInput;
