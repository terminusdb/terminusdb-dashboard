...
var CONST = _interopRequireWildcard(require("./constants/subDocuments.datatypes.constants"));
 ...
 */
describe("Test Subdocuments", function () {
  /**
   * 
  ...
  */
  var setup = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(config) {
      var data, handleSubmit, _render, container, subDocumentButton, addressLine1Input, cityInput, countryInput, postalCodeInput, submitButton;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            subDocumentButton = _react.screen.getByText("Click here to expand SubDocument PermanentAddress");
            expect(subDocumentButton).toBeInTheDocument();
            // click on subdocument button to expand properties
            _context.next = 8;
            return _userEvent["default"].click(subDocumentButton);
          case 8:
            // enter a Address line 1
            addressLine1Input = _react.screen.getByRole('textbox', {
              name: "AddressLine1"
            }); // check if Address line 1 input is available
            expect(addressLine1Input).toBeInTheDocument();
            // enter a Address line 1
            _react.fireEvent.change(addressLine1Input, {
              target: {
                value: config.input["AddressLine1"]
              }
            });

            // enter a City
            cityInput = _react.screen.getByRole('textbox', {
              name: "City"
            });
            ...
            _react.fireEvent.change(cityInput, {
              target: {
                value: config.input["City"]
              }
            });

            // enter a Country
            countryInput = _react.screen.getByRole('textbox', {
              name: "Country"
            }); // check if Country input is available
            expect(countryInput).toBeInTheDocument();
            // enter a Country
            _react.fireEvent.change(countryInput, {
              target: {
                value: config.input["Country"]
              }
            });

            // enter a postalCode
            postalCodeInput = _react.screen.getByRole('textbox', {
              name: "postalCode"
  ...
  test("Create SubDocument property", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var config, data;
  ...
  test("Edit SubDocument property", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
    var config, data;
  ...
  test("View SubDocument type property", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
    var _render2, container, addressLine1Input, cityInput, countryInput, postalCodeInput;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          ...
          })), container = _render2.container; //logRoles(container)
          // Address line 1
          addressLine1Input = _react.screen.getByRole('textbox', {
            name: "AddressLine1"
          }); // check if Address line 1 input is available
