...
var TDBBoolean = function TDBBoolean(_ref) {
  var id = _ref.id,
    name = _ref.name,
    value = _ref.value,
    isKey = _ref.isKey,
  ...
  var _useState = (0, _react.useState)(mode !== CONST.CREATE ? value : false),
  ...
  return /*#__PURE__*/_react["default"].createElement(_InputGroup["default"], {
    ...
    gap: 2
  }, checked && /*#__PURE__*/_react["default"].createElement("input", {
    type: "checkbox",
    id: id,
    name: name,
    checked: true,
    disabled: (0, _utils.checkIfReadOnly)(mode, checked, isKey),
