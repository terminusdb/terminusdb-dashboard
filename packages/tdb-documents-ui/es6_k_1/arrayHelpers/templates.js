...
var GetFieldDisplay = function GetFieldDisplay(_ref) {
  var args = _ref.args,
    props = _ref.props,
  ...
  function fieldDisplay() {
    var _newProps;
    var doc = args.documentFrame[property];
    var placeholder = (0, _placeholderHelper.getPlaceholder)(doc);
    var newProps = (_newProps = {
      ...
      hideFieldLabel: props.hasOwnProperty(CONST.HIDE_FIELD_LABEL) ? props[CONST.HIDE_FIELD_LABEL] : true,
      // always hide label for Set fields
      onChange: function onChange(data, name) {
        return handleElementChange(data, name, element);
      }
    }, _defineProperty(_newProps, "hideFieldLabel", true), _defineProperty(_newProps, "index", element.index.toString()), _newProps);
    return (0, _fieldDisplay.getDisplay)(newProps, args, property);
  }
  return /*#__PURE__*/_react["default"].createElement("span", null, fieldDisplay());
};

// EDIT or CREATE MODE
// Array field templates for lists and sets 
exports.GetFieldDisplay = GetFieldDisplay;
function ArrayFieldTemplate(args, props, property) {
  /** 
  ...
  if (mode === CONST.VIEW && !Object.keys(props.formData).length) return /*#__PURE__*/_react["default"].createElement("div", {
  ...
  return /*#__PURE__*/_react["default"].createElement("div", {
    ...
    return /*#__PURE__*/_react["default"].createElement(_Stack["default"], {
      ...
      className: "w-100"
    }, update && /*#__PURE__*/_react["default"].createElement(GetFieldDisplay, {
      args: args,
      props: props,
      element: element,
      id: id,
