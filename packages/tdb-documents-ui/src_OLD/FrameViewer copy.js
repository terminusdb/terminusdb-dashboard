...
import {checkForCycle} from "./checkForCycle"
    ...
    useEffect(() => {
        //try{ 
            ...
            //if(frame && type && mode) { 
                ...
                let properties=getProperties(frame, type, frame[current], uiFrame, mode, formData, onTraverse, onSelect, extractedDocumentation, type, definitions, setDefinitions)
                
                let alteredProperties = checkForCycle(properties.properties, properties.uiSchema, definitions, mode)

                //console.log("alteredProperties", alteredProperties)

                console.log("properties", properties.properties)
                console.log("uiSchema", properties.uiSchema)
