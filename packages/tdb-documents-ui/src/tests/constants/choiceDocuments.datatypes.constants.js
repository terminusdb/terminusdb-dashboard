...
export const CHOICE_DOCUMENT_DATA_TYPE_FRAME = {
	"@context": {
...
export const CHOICE_DOCUMENT_DATA_TYPE_CREATE_DATA = {
	"@type": "Teacher",
	"name": "Tea Nancy",
	"teach": {
		"@type": "Botony",
...
// expected data on Create 
export const CHOICE_DOCUMENT_DATA_TYPE_EDIT_DATA_ORIGINAL = {
	"@id": "Teacher/12312213",
	"@type": "Teacher",
	"name": "Tea Nancy",
	"teach": {
...
export const CHOICE_DOCUMENT_DATA_TYPE_EDIT_DATA = {
	"@id": "Teacher/12312213",
	"@type": "Teacher",
	"name": "Tea Nancy",
	"teach": {
...
export const EDIT_CONFIG = {
	...
	uiFrame: {},
	type: "Teacher",
	formData: CHOICE_DOCUMENT_DATA_TYPE_EDIT_DATA_ORIGINAL, // pass created data here & we will modify with Edit data
