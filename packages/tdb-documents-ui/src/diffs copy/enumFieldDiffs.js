...
function showAddedElementOriginal(props) {
    return <div className="form-group field field-string  text-danger tdb__diff__enum__original">
...
export function getEnumFieldDiffs(diffPatch, key) {
    ...
    diffUIFrames[ORIGINAL_UI_FRAME][key]["classNames"]="text-danger tdb__diff__enum__original mb-3"
    diffUIFrames[CHANGED_UI_FRAME][key]["classNames"]="text-success tdb__diff__enum__changed mb-3"
