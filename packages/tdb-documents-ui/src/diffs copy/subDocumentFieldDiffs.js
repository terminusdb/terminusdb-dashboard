...
function showRemovedSubDocumentChanged(props) {
...
function showRemovedSubDocumentOriginal(props) {
...
export function getSubDocumentFieldDiffs (fullFrame, frame, diffPatch, item, type) {
    let diffUIFrames={
        originalUIFrame: {
            [item]:{}
        },
    ...
    let subDocumentDiff = generateDiffUIFrames(fullFrame, constructedFrame, type, diffPatch[item])
