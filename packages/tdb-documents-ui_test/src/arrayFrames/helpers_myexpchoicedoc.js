...
import {getChoiceDocumentArrayItems, gatherArrayChoiceDocumentUI} from "../choiceDocumentTypeFrames/helpers" 
 ...
 */ 
 export function getArrayUILayout (frame, item, mode, documentation) {
    ...
    // display custom ui for chocie documents 
    if(mode===CONST.EDIT && frame.properties[item].hasOwnProperty(CONST.INFO) && 
        frame.properties[item][CONST.INFO] === CONST.CHOICECLASSES) {
        uiLayout={
            "items": gatherArrayChoiceDocumentUI(ui),  
            "additionalItems": ui, 
...
export function getViewArrayUILayout (frame, item, formData, documentation) {
    ...
    // display custom ui for chocie documents 
    if(frame.properties[item].hasOwnProperty(CONST.INFO) && 
        frame.properties[item][CONST.INFO] === CONST.CHOICECLASSES) {
        uiLayout={
